...
<AccordionGroup>
  <Accordion title="Set Up Wildcard SSL with Cloudflare" icon="lock">
    ...
    **Step 3: Verify SSL Installation**
    ...
    Confirm the wildcard SSL is working:
    
    ```bash
    # Check certificate details
    openssl s_client -connect yourdomain.com:443 -servername yourdomain.com < /dev/null 2>/dev/null | openssl x509 -noout -text | grep -A 1 "Subject Alternative Name"
    ```
    ...
    **Troubleshooting**
    ...
    <AccordionGroup>
      <Accordion title="Certificate Request Failed" icon="circle-xmark">
        **Common Issues:**
      ...
      <Accordion title="Wildcard Not Covering Subdomains" icon="globe">
        **Issue:** Subdomains show SSL errors
...
Don't want to handle the installation yourself? We offer professional installation services:
...
**Contact sales for pricing and scheduling.**
