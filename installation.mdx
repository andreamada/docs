...
1. Create a database and import it from your folder (_file_to_import.sql)_
2. You also upload the source code and extract the source code for the domain name.
3. Configure the configuration file to connect the database in the **config.php** file
