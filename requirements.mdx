...
<Tabs>
  <Tab title="Minimum Requirements">
    **Small Deployment (Up to 50 websites)**
  ...
  <Tab title="Recommended">
    **Medium Deployment (50-200 websites)**
...
For the Hosted Edition, hardware is fully managed by AreaWP. Resources are allocated based on your plan:

| Plan | CPU Cores | RAM | Storage | Websites |
|------|-----------|-----|---------|----------|
| **Starter** | 4 cores | 8 GB | 100 GB | Up to 50 |
| **Business** | 8 cores | 16 GB | 250 GB | Up to 200 |
| **Enterprise** | 16+ cores | 32+ GB | 500+ GB | Unlimited |
