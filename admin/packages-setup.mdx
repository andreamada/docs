...
description: "Packages are basically products or plans. Packages can appear on order forms and be ordered by clients, or added manually by staff. An ordered package becomes a service, which may or may not recur, depending on the pricing option selected. A recurring service results in recurring invoices being generated for the renewal period. file."
---
...
You can also define and choose here if allow the client to **purchase the theme** or allow to **download** it using respectively the toggle buttons at the end of the page.
