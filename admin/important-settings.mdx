...
- Enable/Disable the CMS (If you're using your own existing landing site, you can use this option to hide our CMS and redirect your customers to the register/login page)

![Company Setup JP](/images/company_setup.JPG)
