...
<ParamField path="image" type="image">
  **Bank Logo** - Upload your bank's logo for easy identification
</ParamField>

<ParamField path="name" type="string" required>
  **Bank Name** - Name of the financial institution (e.g., Vietinbank, Chase Bank, Wells Fargo)
</ParamField>

<ParamField path="user" type="string" required>
  **Account Holder Name** - Full legal name on the bank account
</ParamField>

<ParamField path="number" type="string" required>
  **Account Number (IBAN)** - Bank account number or IBAN for international transfers
</ParamField>

<ParamField path="office" type="string">
  **Bank Location/Branch** - Branch location or bank address
</ParamField>

### Setup Instructions

Add up to **20 bank accounts** for manual payment processing with a sortable interface.
...
<ParamField path="paypal_enabled" default="false" type="boolean">
  **Enable PayPal** - Master toggle to activate PayPal payment processing
</ParamField>

<ParamField path="paypal_custom_name" default="PayPal" type="string">
  **Display Name** - Custom label shown to customers (e.g., "PayPal", "PayPal Express")
</ParamField>

<ParamField path="paypal_mode" default="sandbox" type="select">
  **Environment Mode** - Choose your PayPal environment

  - `sandbox` - Testing environment for development
  - `live` - Production environment for real transactions
</ParamField>

<ParamField path="paypal_client_id" type="string" required>
  **Client ID** - PayPal REST API application client ID
</ParamField>

<ParamField path="paypal_secret" type="string" required>
  **Client Secret** - PayPal REST API application secret key
</ParamField>
