...
<Info>
**AreaWP** is a self-hosted server control panel built for developers, agencies, and hosting providers. Manage WordPress sites, Docker apps, databases, billing, and clients — all from one dashboard, on your own infrastructure.
</Info>
